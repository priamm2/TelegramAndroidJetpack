    ...
    private void updateRows(boolean animated) {
        ...
        if (currentType != -1) {
            ...
            if (expanded) {
                ...
                items.add(ItemInner.asSetting(1, LocaleController.getString("Vibrate", R.string.Vibrate), getString(vibrateLabels[Utilities.clamp(vibrate, vibrateLabels.length - 1, 0)])));
